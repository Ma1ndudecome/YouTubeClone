                    ...
                    <div class="line"></div>
                     <div class="Header_Main_container_video">
                        ...
                        <div class="Shorts_Container_rightArrow">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="" style="transform: rotate(175deg)">вв
                                <path d="M14.2893 5.70708C13.8988 5.31655 13.2657 5.31655 12.8751 5.70708L7.98768 10.5993C7.20729 11.3805 7.2076 12.6463 7.98837 13.427L12.8787 18.3174C13.2693 18.7079 13.9024 18.7079 14.293 18.3174C14.6835 17.9269 14.6835 17.2937 14.293 16.9032L10.1073 12.7175C9.71678 12.327 9.71678 11.6939 10.1073 11.3033L14.2893 7.12129C14.6799 6.73077 14.6799 6.0976 14.2893 5.70708Z" fill="#0F0F0F"/>
                            </svg>
                        </div>
                        <h1>For You</h1>
...
export function InfoAboutChannel(){
    ...
    <div class="backdropInfo dF aiC jcC">
        <div class="block_info">
            <div class="block_info_header dF jc jcsB">
                <h1>Про канал</h1>
                <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24" focusable="false" aria-hidden="true"><path d="m12.71 12 8.15 8.15-.71.71L12 12.71l-8.15 8.15-.71-.71L11.29 12 3.15 3.85l.71-.71L12 11.29l8.15-8.15.71.71L12.71 12z"></path></svg>
            </div>
            <div class="block_info_main dF fdC">
                <h1>Відомості про канал</h1>
                    <div class="subscriber">
                        ...
                        <div class="subscriber_text">
                            Підписалося 22 користувачі
                        </div>
                    </div>
                    <div class="block_info_main_video">
                        <div class="block_info_main_video_svg">
                          ...
                          <div class="block_info_main_video_text">
                            29 відео
                        </div>
                    </div>
                     <div class="block_info_main_view">
                        <div class="block_info_main_video_view">
                          ...
                          <div class="block_info_main_view_text">
                            1620 переглядів
                        </div>
                    </div>
                    <div class="block_info_main_dateCreated">
                        <div class="block_info_main_video_dateCreated">
                          ...
                          <div class="block_info_main_dateCreated_text">

                    ...
                    <div class="AllComment_Container dF fdC">
                        <div class="AllComment_Container_item dF">
                            <div class="AllComment_Container_item_img">
                                <img src="https://yt3.ggpht.com/beaCQcI239DgoC0oefyWvCI4_uDW-q7ny4HJSLqOl6APrPbZvVNZ3MxSvbt9oBoO23xh1JAMHA=s88-c-k-c0x00ffffff-no-rj">
                            </div>
                            <div class="AllComment_Container_item_info">
                                <div class="AllComment_Container_item_info_userNameDate">
                                    <span class="userNameDate_userName">@fenix<span>
                                    <span class="userNameDate_Date">2 minutes later</span>
                                </div>
                                <div class="AllComment_Container_item_text">
                                    Фанат этой карты, просто шедевр. Максимально веселая карта, чего стоит один лишь New Ad Campaign. Бегать с петухом, крокодилом, мухой и остальным зоопарком просто идеально!
                                </div>
                                <div class="AllComment_Container_item_statistic dF">
                                    <div class="AllComment_Container_item_statistic_like">
                                        <div class="AllComment_Container_item_statistic_like_svg">
                                        ...
                                        <span class="AllComment_Container_item_statistic_like_count">1</span>
                                    </div>
                                    <div class="AllComment_Container_item_statistic_disLike">
                                        <div class="AllComment_Container_item_statistic_disLike_svg">
                                        </div>
                                    </div>
                                    <div class="AllComment_Container_item_statistic_repty">Repty</div>
                                </div>
                            </div>
                        </div>
                    </div>
